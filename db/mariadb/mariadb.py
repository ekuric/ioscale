    ...
    with ThreadPoolExecutor(max_workers=len(config.db_hosts)) as pool:
        ...
        for host in config.db_hosts:
            ...
            cmd = (
                ...
                "for pkg in git curl vim wget mariadb mariadb-server mariadb-server-utils mariadb-errmsg; do "
                ...
                "  dnf -y install git curl vim wget mariadb mariadb-server mariadb-server-utils mariadb-errmsg; "
